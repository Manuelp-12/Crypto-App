...
UPDATE: Now incldues predicted price for the next 24 hours using Facebook Prophet, a python data forecasting machine learning library. The predicted future price shows as a gray line at the end of the chart.
