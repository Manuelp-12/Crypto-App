...
function StatisticView({data, width}) {
            ...
            {stat.percentageChange != null ? (
                <View style={styles.percent}>
                    <Image source={triangle} style={[
                        styles.image, {tintColor: (stat.percentageChange ?? 0) >= 0 ? mainTheme.green_color : mainTheme.red_color},
                        {
                            transform: [
                                {
                                    rotate: (stat.percentageChange ?? 0) >= 0 ? '0deg' : '180deg',
                                }
                            ]
                        }
                    ]} />
